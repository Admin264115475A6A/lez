...
class Blockchain:
    ...
    def validate_block(self, index):
        """
        Validate a specific block at the given index in the blockchain.
        """
        ...
        if block.hash != block.calculate_hash():
            print(f"Block {block.index} is invalid: Hash mismatch!")
            return False
        ...
        if block.index > 0:
            ...
            if block.previous_hash != previous_block.hash:
                print(f"Block {block.index} is invalid: Previous hash mismatch!")
                return False
    ...
    def save_to_json(self, json_file_path):
        ...
        try:
            ...
            print(f"Error saving blockchain to JSON: {e}")
